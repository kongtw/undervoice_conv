...
def spk_reg():
    ...
    cfg_dict['IvTest'] = 'ivTest_EFR_Mahalanobis_l'
    ...
    ndx_dir = '/home/dell/runtimedata/spk_test_data/ndx/'
    ...
    cm_str = 'bin/IvTest --config %s --outputFilename %s --ndxFilename %s --targetIdList %s --loadVectorFilesPath %s ' \
             ...
             % (dest_test_cfg, str(os.getpid()) + '_res.txt', test_ndx_name, dest_train_model, iv_raw, iv_raw,
                dest_norm_ndx)
    os.system(cm_str)
